...
const Testimonails = () => {
  return (
    ...
    initial={{ opacity: 0, x:100}}
      ...
      viewport={{once:true}}
    className='container max-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Testimonails'>
      ...
      <div className='flex flex-wrap justify-center gap-8 '> {testimonialsData.map((testimonial, index) => (

        <div key={index} className='max-w-[312px] border shadow-lg rounded px-8 py-12 text-center'>
